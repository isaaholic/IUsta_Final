...
namespace API.Extentions
{
    public static class Extentions
    {
        ...
        public static async void RegisterFirstAdmin(this WebApplication app)
        {
            ...
            var user = await userManager.FindByEmailAsync("admin@iusta.com");
            if (user is null)
            {
                user = new User
                {
                    ...
                    LastName = "Mammadli",
                    UserName = "iustaadmin",
                    Email = "admin@iusta.com",
                    EmailConfirmed = true
                };
                var result = await userManager.CreateAsync(user, "Admin@2003");
        ...
        public static IServiceCollection AddDomainServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<Application.Services.ILogger, Logger>();
